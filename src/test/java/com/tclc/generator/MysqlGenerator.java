...
public class MysqlGenerator {
    ...
    private static String outputDir ="d:\\deptemp";//生成的位置
    ...
    private static String tablePrefix ="emp";//数据库表的前缀，如tbl_user
    private static String [] tables = {"emp_chanliangguagou"};	//生成的表
